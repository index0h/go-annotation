...
func TestStorage_Clone(t *testing.T) {
	...
	ctrl.AssertNotSame(model.Namespaces[0], actual.(*Storage).Namespaces[0])
	ctrl.AssertNotSame(model.Namespaces[0].Files[0], actual.(*Storage).Namespaces[0].Files[0])
	ctrl.AssertNotSame(
		model.Namespaces[0].Files[0].Annotations[0],
		actual.(*Storage).Namespaces[0].Files[0].Annotations[0],
	)
	ctrl.AssertNotSame(model.Namespaces[1], actual.(*Storage).Namespaces[1])
}
...
func TestStorage_ScanRecursive(t *testing.T) {
	...
	model.ScanRecursive("", fs.RootPath(), "ignored")
	...
	ctrl.AssertSame(file11, model.Namespaces[0].Files[0])
	ctrl.AssertSame(file41, model.Namespaces[3].Files[0])
}
...
func TestStorage_ScanRecursive_WithRootNamespace(t *testing.T) {
	...
	model.ScanRecursive(rootNamespace, fs.RootPath(), "ignored")
	...
	ctrl.AssertSame(file11, model.Namespaces[1].Files[0])
	ctrl.AssertSame(file41, model.Namespaces[4].Files[0])
}
...
func TestStorage_ScanRecursive_WithNotReadableFolder(t *testing.T) {
	...
	ctrl.Subtest("").
		Call(model.ScanRecursive, fs.RootPath(), "").
...
func TestStorage_ScanFiles(t *testing.T) {
	...
	actual := model.ScanFiles(fs.RootPath())
...
func TestStorage_ScanFiles_WithNotExistsFolder(t *testing.T) {
	...
	ctrl.Subtest("").
		Call(model.ScanFiles, "/NotExistedPathHere").
		ExpectPanic(ctrl.Type(&os.PathError{}))
}
...
func TestStorage_ScanFiles_WithReadFileError(t *testing.T) {
	...
	ctrl.Subtest("").
		Call(model.ScanFiles, fs.RootPath()).
		ExpectPanic(ctrl.Type(&os.PathError{}))
}
...
func TestStorage_RemoveOldGeneratedFiles_WithFileNotExists(t *testing.T) {
	...
	ctrl.Subtest("").
		Call(model.RemoveOldGeneratedFiles).
		ExpectPanic(ctrl.Type(&os.PathError{}))
}
...
func TestStorage_WriteGeneratedFiles(t *testing.T) {
	...
	model.WriteGeneratedFiles()

	fs.AssertFileExists("root/file.go")
	fs.AssertFileContent("root/file.go", model.Namespaces[0].Files[0].String())
	fs.AssertFileExists("root/do_not_override.go")
	fs.AssertFileContent("root/do_not_override.go", model.Namespaces[0].Files[1].Content)
	fs.AssertFileExists("root/folder1/folder2/folder3/second_file.go")
	fs.AssertFileContent("root/folder1/folder2/folder3/second_file.go", model.Namespaces[1].Files[0].String())
}
...
func TestStorage_WriteGeneratedFiles_WithCreateFolderError(t *testing.T) {
	...
	ctrl.Subtest("").
		Call(model.WriteGeneratedFiles).
		ExpectPanic(ctrl.Type(&os.PathError{}))
}
